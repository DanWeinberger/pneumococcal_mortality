...
p2a <- death_plot_fun(year,month, agec, pneumococcal_pneum) 
...
p3.ds <- merge(p3$ts, pop2, by=c('agec','race_recode_new', 'date', 'year')) %>%
  ...
  group_by(race_recode_new, agec) %>% #NOTE PROBLEM HERE__THIS IS SUMMING ACROSS ALL 6 years rather than taking an annual rate
